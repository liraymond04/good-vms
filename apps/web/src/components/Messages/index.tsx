  ...
  return (
    <div className="container mx-auto max-w-screen-xl grow px-0 sm:px-5">
      <div className="grid grid-cols-11">
        ...
        <div className="col-span-11 border-x border-y bg-white md:col-span-11 lg:col-span-4 dark:border-gray-700 dark:bg-black">
          <Conversations isClientLoading={isLoading} />
        </div>
        <div className="col-span-11 border-y border-r bg-white md:col-span-11 lg:col-span-7 dark:border-gray-700 dark:bg-black">
