...
const NavPost: FC = () => {
  ...
  return (
    <button
      className="bg-custom-pink mb-5 mt-5 inline-flex hidden w-full items-center justify-center rounded-full px-4 py-2 text-black focus:outline-none md:block text-white"
      onClick={openModal}
