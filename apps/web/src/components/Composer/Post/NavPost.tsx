...
const NavPost: FC = () => {
  ...
  return (
    <button
      className="bg-custom-pink mb-5 mt-5 inline-flex hidden w-full items-center justify-center rounded-full px-4 py-2 text-black text-white focus:outline-none md:block"
      onClick={openModal}
